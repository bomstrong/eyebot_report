...
\begin{ganttchart}[vgrid, hgrid]{1}{17}
	\gantttitle{Gantt Chart (week 35-51)}{17} \\
	\gantttitlelist{35,...,51}{1} \\

	%\ganttgroup{Group 1}{1}{10} \\
	%\ganttbar{Task 1}{1}{3} \\
	%\ganttbar{Task 2}{4}{10} \\

	\ganttgroup{Practical work}{1}{15} \\
	\ganttbar{Motor}{1}{5} \\
	\ganttbar{Camera}{1}{5} \\
	\ganttmilestone{Camera decision milestone}{4} \\
	\ganttbar{Distance sensors}{4}{7} \\
	\ganttbar{I2C Communication}{4}{5} \\
	\ganttbar{Line following / PID}{4}{10} \\
	\ganttbar{Testing (overall)}{10}{15} \\

	\ganttgroup{Documentation}{10}{17} \\
	\ganttbar{Simulation}{13}{17} \\
	\ganttbar{Report}{13}{17} \\
